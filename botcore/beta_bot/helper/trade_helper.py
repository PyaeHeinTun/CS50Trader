...
def calculate_deviation(num1, num2, order_book) -> int:
...
def count_digits_in_float(num) -> int:
...
def add_deviation(order_book, given_value, is_minus, num_pips) -> float:
...
def calculate_profit_ratio(open_rate, exit_rate, is_short, leverage, stake_ammount) -> int:
...
def last_seven_day_in_int() -> list:
